...
class namazvakti():
    ...
    def sehirler(self, ulke_id):
        ...
        if str(ulke_id) in self.__veritabani:
            ...
            if ulke["ilce_listesi_varmi"]:
                ...
                liste = [int(i) for i in ulke["sehirler"]]
                liste.sort()
                ...
                for sehir in ulke["sehirler"].values():
                    liste1 = [int(i) for i in sehir["ilceler"]]
                    liste1.sort()
    ...
    def __yerBilgisi(sehir_id):
        ...
        # adres dosyası
        adresDosyasi = os.path.join(os.path.join(
            "./bin/namaz_vakti/"), "db", "adresler.ndb")
    ...
    def __tarihDuzelt(self, bozukTarih):
        ...
        ay = "0" + str(ay) if ay < 10 else str(ay)
        yil = bozulanTarih[2]
        return (gun + "." + ay + "." + yil)
